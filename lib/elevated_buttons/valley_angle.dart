...
class ValleyAngle extends StatefulWidget {
  const ValleyAngle({Key? key}) : super(key: key);

  @override
  _ValleyAngleState createState() => _ValleyAngleState();
}

class _ValleyAngleState extends State<ValleyAngle> {
                ...
                children: [
                  Card(
                      child: const Padding(
                        ...
                        child: Text(
                          'Horizontal distance (Valley angle)',
                          style: TextStyle(
